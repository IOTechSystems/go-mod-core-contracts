...
type ResourceProperties struct {
	...
	Units        string `json:"units" yaml:"units,omitempty"`
	Minimum      string `json:"minimum" yaml:"minimum,omitempty"`
	Maximum      string `json:"maximum" yaml:"maximum,omitempty"`
	DefaultValue string `json:"defaultValue" yaml:"defaultValue,omitempty"`
	Mask         string `json:"mask" yaml:"mask,omitempty"`
	Shift        string `json:"shift" yaml:"shift,omitempty"`
	Scale        string `json:"scale" yaml:"scale,omitempty"`
	Offset       string `json:"offset" yaml:"offset,omitempty"`
	Base         string `json:"base" yaml:"base,omitempty"`
	Assertion    string `json:"assertion" yaml:"assertion,omitempty"`
