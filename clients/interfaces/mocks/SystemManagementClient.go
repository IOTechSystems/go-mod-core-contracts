...
func (_m *SystemManagementClient) DoOperation(ctx context.Context, reqs []requests.OperationRequest) ([]common.BaseResponse, errors.EdgeX) {
	...
	if len(ret) == 0 {
		panic("no return value specified for DoOperation")
	}

	var r0 []common.BaseResponse
	var r1 errors.EdgeX
	if rf, ok := ret.Get(0).(func(context.Context, []requests.OperationRequest) ([]common.BaseResponse, errors.EdgeX)); ok {
		return rf(ctx, reqs)
	}
...
func (_m *SystemManagementClient) GetConfig(ctx context.Context, services []string) ([]common.BaseWithConfigResponse, errors.EdgeX) {
	...
	var r1 errors.EdgeX
	if rf, ok := ret.Get(0).(func(context.Context, []string) ([]common.BaseWithConfigResponse, errors.EdgeX)); ok {
		return rf(ctx, services)
	}
...
func (_m *SystemManagementClient) GetHealth(ctx context.Context, services []string) ([]common.BaseWithServiceNameResponse, errors.EdgeX) {
	...
	var r1 errors.EdgeX
	if rf, ok := ret.Get(0).(func(context.Context, []string) ([]common.BaseWithServiceNameResponse, errors.EdgeX)); ok {
		return rf(ctx, services)
	}
...
func (_m *SystemManagementClient) GetMetrics(ctx context.Context, services []string) ([]common.BaseWithMetricsResponse, errors.EdgeX) {
	...
	var r1 errors.EdgeX
	if rf, ok := ret.Get(0).(func(context.Context, []string) ([]common.BaseWithMetricsResponse, errors.EdgeX)); ok {
		return rf(ctx, services)
	}
...
func NewSystemManagementClient(t interface {
	mock.TestingT
	Cleanup(func())
