...
// NewDeviceServiceCommandClient creates a new instance of DeviceServiceCommandClient. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewDeviceServiceCommandClient(t testing.TB) *DeviceServiceCommandClient {
